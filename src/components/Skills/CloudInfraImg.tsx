export default function CloudInfraImg(props: { theme: any }) {
  const { theme } = props;
  return (
    <svg
    ...
    >
      ...
      <rect y="625.16" width="645.61" height="21.88" fill={theme.palette.custom.imageDark} />
      <rect
        x="27.36"
        y="647.05"
        width="590.89"
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="309.5" cy="189.88" r="121.14" fill={theme.palette.custom.dark} />
      <circle cx="309.5" cy="217.64" r="116.09" fill={theme.palette.custom.skinColor} />
      <path
      ...
      <path
        ...
        opacity="0.1"
      />
      <circle cx="404.08" cy="619.68" r="27.76" fill={theme.palette.custom.skinColor} />
      <circle cx="214.91" cy="619.68" r="27.76" fill={theme.palette.custom.skinColor} />
      <g opacity="0.7">
        <rect
          x="218.04"
          y="461"
