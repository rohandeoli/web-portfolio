import './GreetingImage.css';

function GreetingImage(props: { theme: any }) {
    ...
    return (
        <svg
            ...
            role="img"
            aria-label="Illustration of a programmer working on a laptop"
        >
            <title>Programmer Illustration</title>
            <path
            ...
            <g id="head">
                <g id="ccc">
                    <rect
                        ...
                        height="47"
                        width="27"
                        fill={theme.palette.custom.skinColor}
                        y="147.5"
                        x="105.5"
                    />
                </g>
                ...
                <g id="eyey2">
                    <circle id="circle113" r="5" cy="114" cx="98.4" fill={theme.palette.custom.dark} />
                    <circle id="circle115" r="5" cy="114" cx="136.9" fill={theme.palette.custom.dark} />
                </g>
            </g>
            <g id="shirt">
                <path
            ...
            <g id="legs">
                <g id="g188">
                    <path
                        ...
                        fill={theme.palette.custom.avatarMisc}
                    />
                </g>
                <g id="g192">
                    <path
                        ...
                        fill={theme.palette.custom.avatarShoes}
                    />
                </g>
                <g id="g196">
                    <polygon
                    ...
                    <g id="g210">
                        ...
                        <g id="g208">
                            <path
                                ...
                                fill={theme.palette.custom.imageDark}
                            />
                        </g>
                    </g>
                    <g id="logobook">
                ...
                <g id="g222">
                    <path
                        ...
                        fill={theme.palette.custom.imageClothes}
                    />
                </g>
                <g id="g226">
                    <path
